...
{% assign posts = site.posts | where_exp: "post", "post.categories contains 'AI-기술-트렌드'" %}
...
{% assign pages_decimal = total_posts | divided_by: posts_per_page | times: 1.0 %}
...
<div class="pagination">
  {% for i in (1..total_pages) %}
    ...
    {% else %}
      <a href="{{ '/ai-tech/page' | append: i | relative_url }}">{{ i }}</a>
    {% endif %}
  {% endfor %}
</div>
{% endif %}